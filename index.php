...
<section class="content jumbotron first" id="main" role="main" tabindex="-1">
	<div class="container">
		<div class="top-section">
			...
			<h2>Website and Application Design &amp; Development</h2>
			<div>
				<p>&nbsp;</p>
		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				ini_set('display_errors', 1);
					...
					if ($stmt = $conn->prepare("SELECT id, time, title, alt, tool, descript, thumbpath, smallpath, mediumpath, largepath FROM websites ORDER BY id DESC LIMIT 3, 2")){
